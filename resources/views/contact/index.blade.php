                        ...
                        {{-- <div class="card-toolbar">
                            <button onclick="create('reports/create', 'Create Report')" class="btn btn-sm btn-light-primary"
                                data-kt-drawer-show="true" data-kt-drawer-target="#kt_drawer_example_permanent"><i
                                    class="ki-duotone ki-plus fs-2"></i>New contact_messages</button>
                        </div> --}}
                    </div>
                    <!--end::Header-->
                    <!--begin::Body-->
                                        ...
                                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="min-w-125px dt-orderable-asc dt-orderable-desc" data-dt-column="3"
                                                ...
                                                tabindex="0"><span class="dt-column-title"
                                                    role="button">Email</span><span class="dt-column-order"></span></th>
                                            <th class="min-w-125px dt-orderable-asc dt-orderable-desc" data-dt-column="3"
                                                rowspan="1" colspan="1" aria-label="Role: Activate to sort"
                                                tabindex="0"><span class="dt-column-title"
                                                    role="button">Subject</span><span class="dt-column-order"></span></th>
                                            <th class="min-w-125px dt-orderable-asc dt-orderable-desc" data-dt-column="3"
                                                rowspan="1" colspan="1" aria-label="Role: Activate to sort"
                                                tabindex="0"><span class="dt-column-title"
                                                    role="button">Message</span><span class="dt-column-order"></span></th>
                                            <th class="min-w-125px dt-orderable-asc dt-orderable-desc" data-dt-column="3"
                                                rowspan="1" colspan="1" aria-label="Role: Activate to sort"
                                                tabindex="0"><span class="dt-column-title"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex flex-column">
                                                        <span class="text-gray-800 mb-1">{{ $value->name }}</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex flex-column">
                                                        <span class="text-gray-800 mb-1">{{ $value->email }}</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex flex-column">
                                                        <span class="text-gray-800 mb-1">{{ $value->subject }}</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex flex-column">
                                                        <span class="text-gray-800 mb-1">{{ $value->message }}</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex flex-column">
                                                        <span class="text-gray-800 mb-1">{{ date('d-m-Y H:i', strtotime($value->created_at)); }}</span>
                                                    </div>
                                                </td>
