                    ...
                    <div class="coh-container coh-ce-8a31fe82">
                        <div>
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div class="coh-container coh-ce-cpt_hero_banner-f2668b67">
                                                        <picture>
                                                            <source data-srcset="{{ asset('assets/images/articles.avif') }}"
                            ...
                            <div
                                ...
                                <div
                                    class="coh-container coh-ce-cpt_container-fe57b20b coh-container-boxed"style="margin-bottom: 4rem;">
                ...
                if ($(window).scrollTop() + $(window).height() >= $(document).height() - 200 &&
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            $('#article-list').append(response.data);
