                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        ...
                        <div class="card-toolbar">
                            <button onclick="create('events/create', 'Create Event')" class="btn btn-sm btn-light-primary"
                                data-kt-drawer-show="true" data-kt-drawer-target="#kt_drawer_example_permanent"><i
                                    class="ki-duotone ki-plus fs-2"></i>New Event</button>
                        </div>
                    </div>
                    <!--end::Header-->
                    <!--begin::Body-->
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <form action="{{ route('events.destroy', $value->id) }}"
