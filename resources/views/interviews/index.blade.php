                                    ...
                                    <thead>
                                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="min-w-125px dt-orderable-asc dt-orderable-desc" data-dt-column="1"
                                                ...
                                                tabindex="0"><span class="dt-column-title" role="button">url</span><span
                                                    class="dt-column-order"></span></th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex flex-column">
                                                        <span
                                                            class="text-gray-800 text-hover-primary mb-1">{{ $value->name }}</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex flex-column">
                                                        <span class="text-gray-800 text-hover-primary mb-1"><a
                                                                href="https://www.youtube.com/watch?v={{ $value->url }}"
                                                                target="_blank">{{ 'https://www.youtube.com/watch?v=' . $value->url }}</a></span>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <form action="{{ route('interviews.destroy', $value->id) }}"
