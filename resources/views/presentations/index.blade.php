            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Presentations</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        ...
                        <div class="card-toolbar">
                            <button onclick="create('presentations/create', 'Create Presentation')"
                                class="btn btn-sm btn-light-primary" data-kt-drawer-show="true"
                                data-kt-drawer-target="#kt_drawer_example_permanent"><i
                                    class="ki-duotone ki-plus fs-2"></i>New Presentation</button>
                        </div>
                    </div>
                    <!--end::Header-->
                    <!--begin::Body-->
                    <div class="card-body py-3">
                        ...
                        <div class="table-responsive">
                            @if ($data->isEmpty())
                                <p class="text-center">No Presentations found.</p>
                            @else
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('presentations.download', $value->id) }}"
                                                                class="menu-link px-3">
                                                                Download
                                                            </a>
                                                        </div>
                                                        <div class="menu-item px-3">
                                                            <form action="{{ route('presentations.destroy', $value->id) }}"
